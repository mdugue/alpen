    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-8">
      ...
      <section className="flex flex-col gap-2 text-sm">
        ...
        <p className="text-muted-foreground">
          ...
          statische Seite über dessen Content Delivery Network ausgeliefert.
          Dabei erhebt und speichert der Hoster automatisch technische
          Zugriffsdaten in sogenannten Server-Logfiles, u. a. IP-Adresse, Datum
          und Uhrzeit des Zugriffs, aufgerufene Seite, Referrer-URL sowie
          Browsertyp und Betriebssystem. Diese Daten dienen ausschließlich dem
          technischen Betrieb, der Absicherung und der Fehleranalyse und werden
          nicht mit anderen Datenquellen zusammengeführt. Rechtsgrundlage ist
          Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einem sicheren
          und funktionsfähigen Betrieb).
        </p>
        <p className="text-muted-foreground">
      ...
      <section className="flex flex-col gap-2 text-sm">
        ...
        <p className="text-muted-foreground">
          ...
          sie beim nächsten Besuch wiederherzustellen. Diese Daten verlassen Ihr
          Gerät nie und werden nicht an diesen oder einen anderen Server
      ...
      <section className="flex flex-col gap-2 text-sm">
        ...
        <p className="text-muted-foreground">
          ...
          (Art. 21) bezüglich Sie betreffender personenbezogener Daten. Wenden
          Sie sich dazu an die oben genannte Kontaktadresse. Außerdem haben Sie
          das Recht, sich bei einer Datenschutz-Aufsichtsbehörde zu beschweren,
          z. B. beim Sächsischen Datenschutzbeauftragten (zuständig am Sitz des
          Verantwortlichen in Dresden).
        </p>
      </section>
