      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-8">
        ...
        <section className="flex flex-col gap-2 text-sm">
          ...
          <p className="text-muted-foreground">
            ...
            Wetterdaten externer Anbieter sowie auf die Plattform Ko-fi (siehe
            Datenschutzerklärung). Für deren Inhalte sind ausschließlich die
            jeweiligen Betreiber verantwortlich; auf sie hat der Betreiber
            dieser Seite keinen Einfluss.
          </p>
          <p className="text-muted-foreground">
