  ...
  <LegalFrame page="datenschutz">
    ...
    <section className="flex flex-col gap-2 text-sm">
      ...
      <ul className="text-muted-foreground list-disc pl-5">
        <li>
          OpenFreeMap (tiles.openfreemap.org) – die voreingestellte Grundkarte,
          solange keine andere gewählt ist
        </li>
        <li>
    ...
    <section className="flex flex-col gap-2 text-sm">
      ...
      <p className="text-muted-foreground">
        Die Fotos in der Detailansicht eines Passes, einer Tour oder eines Orts
        stammen von Wikimedia Commons. Die App speichert nur ihre Beschreibung
        (Titel, Urheber, Lizenz); die Bilddateien selbst lädt Ihr Browser direkt
        von den Servern der Wikimedia Foundation (thumb.wikimedia.org, Wikimedia
        Foundation Inc., USA), sobald Sie eine Detailansicht mit Fotos öffnen.
        Dabei werden Ihre IP-Adresse sowie technische Angaben (z. B. Browsertyp)
        an diese Server übertragen. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f
        DSGVO (berechtigtes Interesse an der Darstellung der Fotos). Welche
        Daten Wikimedia dabei verarbeitet, steht in deren Datenschutzrichtlinie
        unter{" "}
        <a
