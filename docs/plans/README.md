...
| 12  | [Destinations](12-destinations.md)                                    | "where"                                   | L      | 09                   | done ([#63](https://github.com/mdugue/alpen/pull/63))                                        |
...
| 02  | [Real routes instead of the hash](02-real-routes.md)                  | sharing, back button, SEO                 | L      | 01, 28, 33           | done ([#63](https://github.com/mdugue/alpen/pull/63))                                        |
...
| 11  | [Smaller items](11-smaller-items.md)                                  | polish                                    | S each | varies               | done ([#63](https://github.com/mdugue/alpen/pull/63))                                        |
| 08  | [English toggle](08-english-toggle.md)                                | audience                                  | M–L    | 02                   | [done](https://github.com/mdugue/alpen/pull/63)                                              |
...
| 14  | [Road types and tags](14-road-types-and-tags.md)                      | roads that are not passes                 | L      | 09, 05               | in progress (#33, #63) – curation waits for the hosts                                        |
...
| 16  | [One status vocabulary](16-status-vocabulary.md)                      | honesty, one home for the words           | M      | 15                   | [done](https://github.com/mdugue/alpen/pull/40), tail in 31 B                                |
...
| 24  | [Depth per destination](24-depth-per-destination.md)                  | "where", honest counts, readability       | M      | 00                   | in progress (#59, #63) – split waits for the 300th road                                      |
| 25  | [Vosges and Jura](25-vosges-and-jura.md)                              | the weekend, a second range               | M–L    | 09, 05               | in progress ([#63](https://github.com/mdugue/alpen/pull/63)) – mechanism done, curation open |
| 26  | [Pyrenees](26-pyrenees.md)                                            | the Tour's other mountains                | M–L    | 25, 24               | in progress ([#63](https://github.com/mdugue/alpen/pull/63)) – mechanism done, curation open |
| 27  | [Gravel](27-gravel.md)                                                | a second discipline                       | L–XL   | 14, 16, 13           | in progress ([#63](https://github.com/mdugue/alpen/pull/63)) – mechanism done, data open     |
...
| 29  | [The camera as a machine](29-camera-machine.md)                       | camera testable without WebGL             | M–L    | 28                   | done ([#62](https://github.com/mdugue/alpen/pull/62))                                        |
...
| 32  | [The pipeline as plan → execute → apply](32-pipeline-planner.md)      | pipeline testable offline, one retry rule | L      | 00                   | done ([#62](https://github.com/mdugue/alpen/pull/62))                                        |
...
- **12 (Destinations)** was half answered by it. A town carries a verdict for
  ...
  file, its own tab, its outline on the map and the compare sheet – is plan 12
