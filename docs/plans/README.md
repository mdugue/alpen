...
| 03 | [Make the period the hero](03-period-hero.md) | "when" | M | – | in progress |
| 04 | [Climate-aware status](04-climate-aware-status.md) | "when", honesty | S–M | – | in progress |
| 12 | [Destinations](12-destinations.md) | "where" | L | 09 | proposed |
| 05 | [Filters and search](05-filters-and-search.md) | finding things | S–M | – | proposed |
...
| 09 | [Schema validation with zod](09-schema-validation.md) | data safety | S | – | proposed |
| 10 | [Tests](10-tests.md) | refactor safety | M | – | in progress |
