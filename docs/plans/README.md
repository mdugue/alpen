...
| 01  | [Map data out of the React payload](01-map-data-out-of-payload.md) | first load on holiday Wi-Fi | M      | 00 for complete data | [in progress](https://github.com/mdugue/alpen/pull/14) |
