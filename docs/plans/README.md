...
| 32  | [The pipeline as plan → execute → apply](32-pipeline-planner.md)      | pipeline testable offline, one retry rule | L      | 00                   | [in progress](https://github.com/mdugue/alpen/pull/62) (phases A–D) |
