...
| 28  | [One app state: the reducer and its adapters](28-app-state.md)        | one rule per decision, two live bugs      | M      | 15, 16               | in progress (steps 1–3, branch `claude/plan-folder-implementations-nf4lgj`) |
