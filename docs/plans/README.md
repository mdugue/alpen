...
| 28  | [One app state: the reducer and its adapters](28-app-state.md)        | one rule per decision, two live bugs      | M      | 15, 16               | [in progress](https://github.com/mdugue/alpen/pull/62) (steps 1–3)          |
...
| 32  | [The pipeline as plan → execute → apply](32-pipeline-planner.md)      | pipeline testable offline, one retry rule | L      | 00                   | [in progress](https://github.com/mdugue/alpen/pull/62) (phase A)            |
