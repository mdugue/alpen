      ...
      <DialogContent className="max-h-[85vh] grid-rows-[auto_minmax(0,1fr)] sm:max-w-2xl">
        ...
        <div className="flex flex-col gap-4 overflow-y-auto pr-1 text-sm">
          <section className="flex flex-col gap-2">
            <h3 className="text-base font-semibold">Woher kommen die 1–5-Bewertungen?</h3>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground">
              Höhen und Auffahrtsdaten sind gerundete Richtwerte. Schönheit, Bekanntheit, Schwierigkeit und
              Verkehr sind redaktionelle 1–5-Einschätzungen. Der Status je Zeitraum ist eine Heuristik und
              ersetzt keine amtliche Sperrauskunft. Die App dient der groben Routenplanung, nicht der
              Navigation.
            </p>
          </section>
        </div>
