...
| Destination verdict, ranked reach, the inverse  | `lib/destination.ts` (`destinationAt`, `basesFor`, `gradeOfBase`), `components/panel/destination.tsx`, the calibration `scripts/analyze-destinations.ts` (`bun run analyze:destinations`)                                                                                                                                                  |
