...
| Entity routes, their metadata and share images     | `app/[lang]/(explorer)/layout.tsx` (the explorer, `"use cache"`), `app/[lang]/(explorer)/[kind]/[slug]/page.tsx` (+ `opengraph-image.tsx`), `lib/share-text.ts`, `lib/share-image.tsx`, `staticParams`/`getEntity` in `lib/data.ts`                                                                                                                                                                                                                 |
...
| Destination verdict, ranked reach, the inverse     | `lib/destination.ts` (`destinationOf`, `basesOf`, `gradeOfBase`), `components/panel/destination.tsx`, the calibration `scripts/analyze-destinations.ts` (`bun run analyze:destinations`)                                                                                                                                                                                                                                                            |
...
| Legal pages                                        | `app/[lang]/impressum/`, `app/[lang]/datenschutz/` (German only, with an English note)                                                                                                                                                                                                                                                                                                                                                              |
