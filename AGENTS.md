...
- **The map is the page.** No header, toolbar or footer; two floating panels on
  desktop, two independent drawers on a phone, nothing at rest.
  → [why](docs/ui-conventions.md#the-map-is-the-page)
